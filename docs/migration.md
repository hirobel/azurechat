...
* Change the "OPENAI_API_KEY" environment setting to "OPENAI_API_KEY"
...
OPENAI_DALLE_API_KEY=222222
OPENAI_DALLE_API_INSTANCE_NAME=azurechat-dall-e
OPENAI_DALLE_API_DEPLOYMENT_NAME=dall-e
...
OPENAI_VISION_API_KEY=333333
OPENAI_VISION_API_INSTANCE_NAME=azurechat-vision
OPENAI_VISION_API_DEPLOYMENT_NAME=gpt-4-vision
OPENAI_VISION_API_VERSION=2023-12-01-preview
```
